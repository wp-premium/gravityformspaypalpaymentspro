...
class GFPayPalPaymentsProData{
    ...
    public static function insert_transaction($entry_id, $feed_id, $transaction_type, $subscription_id, $transaction_id, $amount){
        global $wpdb;
        $table_name = self::get_transaction_table_name();
        ...
        $sql = $wpdb->prepare(" INSERT INTO $table_name (entry_id, feed_id, transaction_type, subscription_id, transaction_id, amount, is_renewal, date_created)
                                values(%d, %d, %s, %s, %s, %f, %d, utc_timestamp())", $entry_id, $feed_id, $transaction_type, $subscription_id, $transaction_id, $amount, $is_renewal);
        $wpdb->query($sql);
        $id = $wpdb->insert_id;
